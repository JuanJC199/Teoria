 ...
 * @author PC
 */
public class Delete_Proveedor extends javax.swing.JPanel {
    daoProveedores dao;
    String id_proveedor;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Id de Proveedor a eliminar:");
    ...
    private void jButtonEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonEliminarMouseClicked
        this.id_proveedor = this.jTextId_Compra.getText();
        dao.eliminar(this.id_proveedor);
